  ...
  <footer className="bg-primary text-primary-foreground">
    <div className="container-narrow py-12 lg:py-16">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
        <div>
          <h3 className="font-heading text-lg font-semibold mb-4">Nextgen Solutions</h3>
          <p className="text-sm opacity-70 leading-relaxed max-w-xs">
            Independent dairy consulting backed by 40+ years of industry experience and 30 years with Nestlé India.
          </p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="text-sm opacity-70 leading-relaxed">
            Email: info@nextgensolutions.in<br />
            India
          </p>
        </div>
      </div>
      <div className="border-t border-primary-foreground/20 mt-10 pt-6 text-center">
        <p className="text-xs opacity-50">© {new Date().getFullYear()} Nextgen Solutions. All rights reserved.</p>
      </div>
    </div>
  </footer>
);
